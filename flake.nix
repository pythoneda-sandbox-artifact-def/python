...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-git-shared = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-git-def/shared/0.0.86";
    };
    pythoneda-shared-nix-flake-shared = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
  ...
  outputs = inputs:
    ...
    in flake-utils.lib.eachSystem supportedSystems (system:
        ...
        pythoneda-sandbox-artifact-python-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-shared} ${pythoneda-shared-nix-flake-shared} ${pythoneda-shared-pythonlang-domain}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-sandbox-artifact-python-python312;
          ...
          pythoneda-sandbox-artifact-python-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-sandbox-artifact-python-python313;
        ...
        packages = rec {
          ...
          pythoneda-sandbox-artifact-python-python313 =
            pythoneda-sandbox-artifact-python-for {
              python = pkgs.python313;
              pythoneda-shared-artifact-shared =
